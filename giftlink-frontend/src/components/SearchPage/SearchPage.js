                            ...
                            searchResults.map(product => (
                                <div key={product.id} className="card mb-3">
                                    ...
                                    <div className="card-body">
                                        ...
                                        {/* With optional chaining (?.), if product.description is undefined, the expression will short-circuit and return undefined instead of throwing an error, preventing the TypeError you encountered. */}
